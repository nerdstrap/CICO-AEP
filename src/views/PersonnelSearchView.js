...
var template = require('templates/PersonnelSearchView.hbs');
...
var PersonnelSearchView = BaseFormView.extend({
    ...
    doSearch: function () {
        ...
        if (this.searchMethod === SearchMethodEnum.gps) {
            ...
            this.dispatcher.trigger(EventNameEnum.getNearbyStationEntryLogs, this.gpsPersonnelCollection, options);
            ...
            this.dispatcher.trigger(EventNameEnum.getPersonnels, this.manualPersonnelCollection, options);
        }
        return this;
    },
...
module.exports = PersonnelSearchView;