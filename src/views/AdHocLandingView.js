define(function(require) {
    ...
    var CompositeView = require('views/base/CompositeView');
    var template = require('hbs!templates/AdHocLanding');
    var env = require('env');
    var gpsDistanceTemplate = require('hbs!templates/partial/GpsDistancePartial');
    var CICOLocationModel = require('models/CICOLocationModel');

    /**
     * 
     * @type AdHocLandingView
     */
    var AdHocLandingView = CompositeView.extend({
        /**
         * 
         */
